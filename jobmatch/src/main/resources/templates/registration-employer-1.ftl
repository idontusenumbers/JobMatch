...
<body>
  <div class="site-container">
      ...
      <div><progress value="25" max="100"></progress></div><br>
      <form action="registration-employer-2.ftl" method="post" class="form form-login form-register">
        <div class="form-field">
          <input id="login-name" type="text" class="form-input" placeholder="Company name" required>
        </div>
        <div class="form-field">
          <textarea name="login-summary" placeholder="Company summary"></textarea>
        </div>
        <div class="form-field">
