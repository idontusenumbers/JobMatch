...
<body>
  <div class="site-container">
      ...
      <div><progress value="50" max="100"></progress></div><br>
      <form action="registration-employer-3.ftl" method="post" class="form form-login form-register">
      ...
      <div class="form-text">
        <p>
          <a href="#" class="forgot-password">&lt; Previous step</a>
        </p>
      </div>
